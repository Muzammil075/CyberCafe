...
if (isset($_POST["signin"])) {
    ...
    if ($num > 0) {
        ...
        echo "<script>alert('Details are not correct !!');</script>";
...
<html>
   ...
   <body>
      <form class="form-horizontal" action='' method="POST">
         <fieldset>
            <div id="legend">
               <legend class="">Customer Signin</legend>
            </div>
            <div class="control-group">
               <!-- Fullname -->
               <label class="control-label"  for="username">Username</label>
               <div class="controls">
                  <input type="text" id="username" name="username" placeholder="Username" class="input-xlarge" required="true">
               </div>
            </div>
            <div class="control-group">
               <!-- Password-->
            ...
            <div class="control-group">
               <!-- Button -->
               <div class="controls"><a href="index.php">Register Here</a>
               </div>
            </div>
         </fieldset>
      </form>
